...
import avatar1 from "../../../assets/images/users/avator-1.png";
                                                ...
                                                <li key={key} className={chat.userType === "sender" ? "right" : ""}>
                                                    <div className="conversation-list">
                                                        ...
                                                        <div className="user-chat-content">
                                                            ...
                                                            {
                                                                <div className="conversation-name">{chat.userType === "sender" ? "Popup Srl" : chat.userName}</div>
                                                            }
                                                        </div>
                                                    </div>
                                                </li>
                                                    ...
                                                    <div className="conversation-list">
                                                        ...
                                                        <div className="user-chat-content">
                                                            ...
                                                            </div>
                                                            {
                                                                ...
                                                                "Popup Srl" : props.recentChatList[props.active_user].name}</div> : 
