...
const Register = (props) => {
    ...
    document.title = "Register | Popup Chat "
                        ...
                        <Col md={8} lg={6} xl={5}>
                            <div className="text-center ">
                                <Link to="/" className="auth-logo  d-block">
                                    <img src={logodark} alt="" width={"150px"} className="logo logo-dark" />
                                    <img src={logolight} alt="" width={"150px"} className="logo logo-light" />
                                </Link>

                                <h4>{t('Register')}</h4>
                                <p className="text-muted mb-4">{t('Get your Chat account now')}.</p>
                                ...
                                <CardBody className="p-4">
                                    ...
                                    >
                                        ...
                                        <div className="mt-4 text-center">
                                            <p className="text-muted mb-0">{t('By registering you agree to the Popup')} <Link to="#" className="text-primary">{t('Terms of Use')}</Link></p>
                                        </div>
